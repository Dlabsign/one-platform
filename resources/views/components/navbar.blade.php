<nav class="sticky top-0 z-50 w-full backdrop-blur-md bg-[#0b0f1a]/80 border-b border-white/10 font-['DM_Sans',sans-serif]">
    <div class="max-w-[1200px] mx-auto px-6 md:px-8 py-4 flex justify-between items-center">
        ...
        <a href="/" class="flex items-center gap-2 group">
            ...
            <span class="font-['Syne',sans-serif] font-extrabold text-sm sm:text-xl text-white tracking-wide">
        ...
        <div class="flex items-center gap-6 md:gap-8">
            ...
            <a href="https://wa.me/6281259321453" class="hidden md:inline-flex items-center justify-center text-sm font-bold bg-white/5 hover:bg-white/10 text-white px-5 py-2 rounded-full border border-white/10 transition-colors" >
                Contact Me
            </a>
        </div>
